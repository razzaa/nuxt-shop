            ...
            <div class="mx-auto md:p-6 md:w-1/2">
                <div class="flex flex-wrap justify-between">
                    ...
                    <nuxt-link to="/" class="mt-8 text-orange-400 hover:text-orange-600 transition duration-500">
                        <svg class=" w-6 h-6 inline-block align-bottom text-gray-400" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        Back to Home
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <form method="POST" action="#login">
                        ...
                        <div class="mt-8">
                            <p class="text-sm">
                                no account
                                <nuxt-link class="font-bold text-sm text-orange-500 hover:text-orange-800" to="/register">
                                    sign up
                                </nuxt-link>
                            </p>
                        </div>
