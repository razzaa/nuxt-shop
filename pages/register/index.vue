        ...
        <div class="w-full pt-2 p-4">
            ...
            <div class="mx-auto md:p-6 md:w-1/2">
                <div class="flex flex-wrap justify-between">
                    ...
                    <nuxt-link to="/" class="mt-8 text-orange-400 hover:text-orange-600 transition duration-500">
                        <svg class="text-gray-400 w-6 h-6 inline-block align-bottom" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        Back to Home
                    ...
                    <form method="POST" action="#login">
                        <div class="mb-8">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <input id="username" class="block pr-10 shadow appearance-none border-2 border-orange-100 rounded w-full py-2 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-orange-500 transition duration-500 ease-in-out" placeholder="your name" />
                            </div>
                            <strong class="text-red-500 text-xs italic">name is require</strong>
                        </div>
                        <div class="mb-8">
                            <label for="username" class="block text-gray-700 text-sm font-bold mb-2">
                                <span class="text-red-500">&nbsp;*</span>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                </div>
                            ...
                            <strong class="text-red-500 text-xs italic">email is require</strong>
                        </div>
                        <div class="mb-8">
                        ...
                        <div class="mb-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div>
                                    <nuxt-link class="font-bold text-sm text-orange-500 hover:text-orange-800" to="#">
                                        forgot password
                                    </nuxt-link>
                                </div>
                            </div>
                        ...
                        <div class="mt-8">
                            <p class="text-sm">
                                no account
                                <nuxt-link class="font-bold text-sm text-orange-500 hover:text-orange-800" to="/login">
                                    sign in
                                </nuxt-link>
                            </p>
                        </div>
