...
<div class="bg-gray-100 font-sans w-full m-0">
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="block sm:hidden bg-white border-t-2 py-2" v-if="show">
        <div class="flex flex-col">
          <nuxt-link to="/" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Products</nuxt-link>
          <nuxt-link to="/" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Marketplace</nuxt-link>
          <nuxt-link to="/" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Partners</nuxt-link>
          <nuxt-link to="/" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Pricing</nuxt-link>
          <div class="flex justify-between items-center border-t-2 pt-2">
            <nuxt-link to="/login" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Sign in</nuxt-link>
            <nuxt-link to="/register" class="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</nuxt-link>
          </div>
        </div>
      </div>
    </div>
